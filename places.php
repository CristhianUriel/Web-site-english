...
<html lang="es">
    ...
    <head>
        ...
        <title> Place and how to get there</title>
        ...
        <header id="header1" class="header">
            <nav class="navbar navbar-dark bg-primary">
                ...
                <ul class="nav navbar-nav">
                    <li class="nav-item">
                        <h1 class="text-light float-left">Unit 1 Places and How to get there</h1>
                    </li>
                </ul>
                <!--//nav-->
...
<form action="controller/Evaluar.php" method="post">
    <div class="container" >
        ...
        ?>
        <h3 class="text-dark font-weight-bold">Look the pictures and write the occupation. Use the  a or an.</h3>
        <br>
        <div class="row">
            <?php
