        ...
        <header id="header1" class="header">
            <nav class="navbar navbar-dark bg-primary">
                ...
                <ul class="nav navbar-nav">
                    <li class="nav-item">
                        <h1 class="text-light float-left">Unit 1 Family</h1>
                    </li>
                </ul>
                <!--//nav-->
...
<form action="controller/Evaluar.php" method="post">
    <div class="container" >
        ...
        <h3 class="text-dark font-weight-bold">Observe the people in the oval and write their family relationship with the rest of the members of the image.</h3>
        <br>
        <div class="row">
            <?php
