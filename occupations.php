        ...
        <header id="header1" class="header">
            <nav class="navbar navbar-dark bg-primary">
                ...
                <ul class="nav navbar-nav">
                    <li class="nav-item">
                        <h1 class="text-light float-left">Unit 1 occupations</h1>
                    </li>
                </ul>
                <!--//nav-->
...
<form action="controller/Evaluar.php" method="post">
    <div class="container" >
        ...
        <h3 class="text-dark font-weight-bold">Look at the pictures and write the name of the occupation. Use the article a or an for each occupation.</h3>
        <br>
        <div class="row">
    ...
    ?>
                <div class="col-sm-6 col-md-5 col-lg-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="respuesta col-xs-2 col-md-11 col-lg-8" required name="<?php echo 'answer' . $row['id_actividades'] ?>" aria-label="Username" aria-describedby="basic-addon1">
                    </div>
                </div>
    <?php
}
